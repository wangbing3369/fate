                ...
                <el-row>
                    ...
                    <el-col :span="12">
                        <el-form-item label="海关关区代码" prop="custCode">
                            <el-input v-model="form.custCode" maxlength="20"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="海关关区名称" prop="custName">
                            <el-input v-model="form.custName" maxlength="11"/>
                        </el-form-item>
                    </el-col>

                    <el-col :span="12">
                        <el-form-item label="企业海关编码" prop="custNo">
                            <el-input v-model="form.custNo" maxlength="20"/>
                        </el-form-item>
                    </el-col>
                    <el-col :span="12">
                        <el-form-item label="区域代码" prop="areaCode">
                            <el-input v-model="form.areaCode" maxlength="11"/>
                        </el-form-item>
                    </el-col>
